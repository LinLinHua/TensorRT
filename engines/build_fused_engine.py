...
ONNX_PATH = "/workspace/trt_bert/bert_base_fused.onnx"
ENGINE_PATH = "/workspace/trt_bert/bert_fp16_fused.trt"
...
print("Building fused engine (2-5 min)...")
